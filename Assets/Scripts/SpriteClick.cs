...
public class SpriteClick : MonoBehaviour
{
	...
	void OnLeftClick()
	{
		...
		if (this.gameObject.name == "Church")
		{
			...
			VisitButton.GetComponent<VisitScript>().sceneToLoad = "InsideChurch";
		}
		else if (this.gameObject.name == "HeadquartersExterior")
		{
			...
			VisitButton.GetComponent<VisitScript>().sceneToLoad = "InsideHeadquarters";
		}
		else if (this.gameObject.name == "PoliticianBuilding")
		{
			...
			VisitButton.GetComponent<VisitScript>().sceneToLoad = "InsideParliament";
		}else if( this.gameObject.name == "CultistIsland")
        {
            ...
            VisitButton.GetComponent<VisitScript>().sceneToLoad = "InsideCult";
        }else if (this.gameObject.name == "MilitaryExterior")
        {
            ...
            VisitButton.GetComponent<VisitScript>().sceneToLoad = "InsideMilitary";
        }
    }
